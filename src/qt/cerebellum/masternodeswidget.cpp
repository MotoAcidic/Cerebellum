...
#include "qt/cerebellum/forms/ui_masternodeswidget.h"
#include "qt/cerebellum/qtutils.h"
#include "qt/cerebellum/mnrow.h"
#include "qt/cerebellum/mninfodialog.h"

#include "qt/cerebellum/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(CEREBELLUMGUI *parent) :
    PWidget(parent),
    ...
    if (boost::filesystem::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:1111 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
...
void MasterNodesWidget::onCreateMNClicked(){
    if(verifyWalletUnlocked()) {
        if(walletModel->getBalance() <= (GetCurrentCollateral() * COIN)){
            inform(tr("Not enough balance to create a masternode, 4000 cerebellum required."));
            return;
        }
        showHideOp(true);
