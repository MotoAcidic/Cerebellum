...
#include "qt/cerebellum/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/cerebellum/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(CEREBELLUMGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to CEREBELLUMGUI::handleRestart()
