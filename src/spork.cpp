...
// Copyright (c) 2016-2019 The CEREBELLUM developers
...
std::vector<CSporkDef> sporkDefs = {
    ...
    MAKE_SPORK_DEF(SPORK_5_MAX_VALUE,                       1000),          // 1000 cerebellum
    ...
    MAKE_SPORK_DEF(SPORK_16_MN_WINNER_MINIMUM_AGE,      4070908800ULL), // OFF
    ...
    MAKE_SPORK_DEF(SPORK_19_RHF_ACTIVE,                     4070908800ULL), // OFF
};
...
// CEREBELLUM: on startup load spork values from previous session if they exist in the sporkDB
...
void CSporkManager::ProcessSpork(CNode* pfrom, std::string& strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == "spork") {
        ...
        // CEREBELLUM: add to spork database.
