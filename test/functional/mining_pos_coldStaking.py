...
from test_framework.cerebellum_node import CerebellumTestNode
...
class CEREBELLUM_ColdStakingTest(CerebellumTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(CerebellumTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 cerebellum from the pot)
...
if __name__ == '__main__':
    CEREBELLUM_ColdStakingTest().main()
