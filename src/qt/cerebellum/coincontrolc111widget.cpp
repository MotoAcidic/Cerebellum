...
#include "qt/cerebellum/coincontrolc111widget.h"
#include "qt/cerebellum/forms/ui_coincontrolc111widget.h"

CoinControlC111Widget::CoinControlC111Widget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlC111Widget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select cerebellum Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("cerebellum");
    ...
    ui->labelValueAfter->setText("0.00 Cerebellum");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 Cerebellum");
    ui->labelValueFee->setText("0.00 Cerebellum");
...
CoinControlC111Widget::~CoinControlC111Widget()
{
    delete ui;
}
