...
CEREBELLUM Core version *version* is now available from:  <https://github.com/cerebellum-project/cerebellum/releases>
...
An extended description of this large work can be found in the PR [here](https://github.com/CEREBELLUM-Project/CEREBELLUM/pull/1327).
...
Automatic zC111 backup has been disabled. Thus, the following configuration options have been removed  (either as entries in the cerebellum.conf file or as startup flags):
- `autozc111backup`
- `backupzc111`
- `zc111backuppath`
...
The default value for the stake-split threshold has been lowered from 2000 C111, down  to 500 C111.


Dependencies
------------

The minimum required version of QT has been increased from 5.0 to 5.5.1 (the [depends system](https://github.com/cerebellum-project/cerebellum/blob/master/depends/README.md) provides 5.9.7)
...
The p2p alert system has been removed in [#1372](https://github.com/CEREBELLUM-Project/CEREBELLUM/pull/1372) and the 'alert' message is no longer supported.
...
The `-reservebalance` configuration/startup option has been removed ([PR #1373](https://github.com/CEREBELLUM-Project/CEREBELLUM/pull/1373)).
