...
// Copyright (c) 2020 The CEREBELLUM Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef CEREBELLUM_SCRIPTPUBKEYMAN_H
#define CEREBELLUM_SCRIPTPUBKEYMAN_H
...
#endif //CEREBELLUM_SCRIPTPUBKEYMAN_H
