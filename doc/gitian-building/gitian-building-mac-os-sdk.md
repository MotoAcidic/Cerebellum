...
The script [extract-osx-sdk.sh](https://github.com/cerebellum-project/cerebellum/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
cerebellum/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/cerebellum-project/cerebellum/blob/master/doc/README_osx.md) for troubleshooting tips.