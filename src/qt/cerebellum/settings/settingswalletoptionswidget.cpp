...
#include "qt/cerebellum/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/cerebellum/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(CEREBELLUMGUI* _window, QWidget *parent) :
