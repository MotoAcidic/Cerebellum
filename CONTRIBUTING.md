Contributing to CEREBELLUM Core
============================

The CEREBELLUM Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/cerebellum-project/cerebellum/blob/master/doc/translation_process.md)
...
The following applies to code changes to the CEREBELLUM Core project, and is not to be
confused with overall CEREBELLUM Network Protocol consensus changes.

Whether a pull request is merged into CEREBELLUM Core rests with the project merge
...
Patches that change CEREBELLUM consensus rules are considerably more involved than
...
Where a patchset proposes to change the CEREBELLUM consensus, it must have been
...
The project leader is the release manager for each CEREBELLUM Core release.
