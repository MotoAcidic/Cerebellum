...
#include "qt/cerebellum/loadingdialog.h"
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        bool ret = openStandardDialog(
                ...
                tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR 1111</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                tr("ENCRYPT"), tr("CANCEL")
        );
        if (ret) {
            if (newpass1 == newpass2) {
                newpassCache = newpass1;
                CEREBELLUMGUI* window = static_cast<CEREBELLUMGUI*>(parentWidget());
...
{
    CEREBELLUMGUI* gui = static_cast<CEREBELLUMGUI*>(parentWidget());
...
{
    hide();
    static_cast<CEREBELLUMGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("CEREBELLUM will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your 1111s from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
