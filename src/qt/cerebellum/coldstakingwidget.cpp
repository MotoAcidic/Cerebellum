...
#include "qt/cerebellum/coldstakingwidget.h"
#include "qt/cerebellum/forms/ui_coldstakingwidget.h"
#include "qt/cerebellum/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/cerebellum/requestdialog.h"
#include "qt/cerebellum/tooltipmenu.h"
#include "qt/cerebellum/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(CEREBELLUMGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your C111s, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept cerebellum delegation / Delegate cerebellum"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select cerebellum outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 cerebellum" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
