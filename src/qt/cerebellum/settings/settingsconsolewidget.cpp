...
#include "qt/cerebellum/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/cerebellum/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(CEREBELLUMGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(){
    ...
    message(CMD_REPLY, (tr("Welcome to the cerebellum RPC console.") + "<br>" +
