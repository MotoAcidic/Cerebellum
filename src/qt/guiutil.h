...
/** Utility functions used by the CEREBELLUM Qt UI.
 */
namespace GUIUtil
{
...
// Render cerebellum addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZc111 = false);
...
// Parse "cerebellum:" URI into recipient object, return true on successful parsing
