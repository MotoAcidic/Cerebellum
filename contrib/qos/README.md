...
This means one can have an always-on cerebellumd instance running, and another local cerebellumd/cerebellum-qt instance which connects to this node and receives blocks from it.
