...
The build script we'll be using is contained in the CEREBELLUM github repository ([contrib/gitian-build.py](https://github.com/cerebellum-project/cerebellum/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the CEREBELLUM repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/CEREBELLUM-Project/CEREBELLUM/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, cerebellum-detached-sigs, and cerebellum GitHub repos.
