...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Cerebellum Core cerebellum-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  Cerebellum-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Cerebellum transaction") + "\n" +
                               "  Cerebellum-tx [options] -create [commands]   " + _("Create hex-encoded Cerebellum transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cerebellum transaction
