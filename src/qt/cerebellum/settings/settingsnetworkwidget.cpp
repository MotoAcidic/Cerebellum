...
#include "qt/cerebellum/settings/settingsnetworkwidget.h"
#include "qt/cerebellum/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/cerebellum/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(CEREBELLUMGUI* _window, QWidget *parent) :
