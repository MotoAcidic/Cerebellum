...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/cerebellum-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/cerebellum-cli.cpp \
           src/cerebellum-tx.cpp \
           src/cerebellum.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/cerebellum.qrc src/qt/cerebellum_locale.qrc

TRANSLATIONS += src/qt/locale/cerebellum_bg.ts \
                src/qt/locale/cerebellum_de.ts \
                src/qt/locale/cerebellum_en.ts \
                src/qt/locale/cerebellum_es.ts \
                src/qt/locale/cerebellum_fi.ts \
                src/qt/locale/cerebellum_fr.ts \
                src/qt/locale/cerebellum_it.ts \
                src/qt/locale/cerebellum_ja.ts \
                src/qt/locale/cerebellum_pl.ts \
                src/qt/locale/cerebellum_pt.ts \
                src/qt/locale/cerebellum_ru.ts \
                src/qt/locale/cerebellum_sk.ts \
                src/qt/locale/cerebellum_sv.ts \
                src/qt/locale/cerebellum_vi.ts \
                src/qt/locale/cerebellum_zh_CN.ts \
                src/qt/locale/cerebellum_zh_TW.ts
