...
#include "qt/cerebellum/forms/ui_masternodewizarddialog.h"
    ...
    walletModel(model)
{
    ...
    ui->lineEditPort->setPlaceholderText("e.g 1111");
    ...
    if (walletModel->isRegTestNetwork()) {
        ...
        ui->lineEditPort->setEnabled(false);
        ui->lineEditPort->setText("1122");
    } else {
        ui->lineEditPort->setText("1111");
    }
...
bool MasterNodeWizardDialog::createMN()
{
    if (walletModel) {
        ...
        SendCoinsRecipient sendCoinsRecipient(QString::fromStdString(address.ToString()), QString::fromStdString(alias), GetCurrentCollateral() * COIN, "");
