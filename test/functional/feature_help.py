...
"""Verify that starting cerebellum with -h works as expected."""
import subprocess

from test_framework.test_framework import CerebellumTestFramework
from test_framework.util import assert_equal

class HelpTest(CerebellumTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cerebellum with -h for help text")
        ...
        self.log.info("Start cerebellum with -version for version information")
