/* src/config/cerebellum-config.h.  Generated from cerebellum-config.h.in by configure.  */
/* src/config/cerebellum-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef C111_CONFIG_H

#define C111_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/Cerebellum/cerebellum/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Cerebellum Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Cerebellum Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cerebellum"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://cerebellum.org/"
