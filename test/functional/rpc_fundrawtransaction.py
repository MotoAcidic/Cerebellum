...
class RawTransactionsTest(CerebellumTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid cerebellum address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid cerebellum address" in e.error['message'])
