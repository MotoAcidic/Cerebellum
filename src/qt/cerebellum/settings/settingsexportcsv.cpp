...
#include "qt/cerebellum/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(CEREBELLUMGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filenameRet = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("CEREBELLUM_tx_csv_export(*.csv)") : tr("CEREBELLUM_addresses_csv_export(*.csv)"),
                                        nullptr);
