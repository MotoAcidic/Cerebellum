...
// Copyright (c) 2016-2020 The CEREBELLUM developers
...
public:
    ...
    static bool HasZcTxesIfNeeded(const TransactionRecord& record) {
        return (record.type == TransactionRecord::ZerocoinMint ||
                ...
                record.type == TransactionRecord::ZerocoinSpend_Change_zC111 ||
...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeMint:
        return tr("cerebellum Stake");
    case TransactionRecord::StakeZC111:
        return tr("zC111 Stake");
    case TransactionRecord::StakeDelegated:
        return tr("cerebellum Cold Stake");
    case TransactionRecord::StakeHot:
        return tr("cerebellum Stake on behalf of");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted cerebellum to zC111");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zC111");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received cerebellum from zC111");
    case TransactionRecord::ZerocoinSpend_Change_zC111:
        return tr("Minted Change as zC111 from zC111 Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zC111 to cerebellum");
    default:
        return QString();
    }
}
...
QVariant TransactionTableModel::data(const QModelIndex& index, int role) const
{
    ...
    case Qt::ForegroundRole:
        ...
        if (rec->type == TransactionRecord::Generated || rec->type == TransactionRecord::StakeMint ||
                rec->type == TransactionRecord::StakeZC111 || rec->type == TransactionRecord::MNReward) {
