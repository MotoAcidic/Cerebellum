...
public:
    ...
    bool WriteZC111Seed(const uint256& hashSeed, const std::vector<unsigned char>& seed);
    bool ReadZC111Seed(const uint256& hashSeed, std::vector<unsigned char>& seed);
    bool ReadZC111Seed_deprecated(uint256& seed);
    bool EraseZC111Seed();
    bool EraseZC111Seed_deprecated();

    bool WriteZC111Count(const uint32_t& nCount);
    bool ReadZC111Count(uint32_t& nCount);
