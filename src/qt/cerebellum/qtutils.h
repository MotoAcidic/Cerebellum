...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, CEREBELLUMGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, CEREBELLUMGUI *gui, double posX = 3);
