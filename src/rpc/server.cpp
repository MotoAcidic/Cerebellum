...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop cerebellum server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "cerebellum server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CEREBELLUM features */
        {"cerebellum", "listmasternodes", &listmasternodes, true, true, false},
        {"cerebellum", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cerebellum", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cerebellum", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"cerebellum", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"cerebellum", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"cerebellum", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cerebellum", "masternodedebug", &masternodedebug, true, true, false},
        {"cerebellum", "startmasternode", &startmasternode, true, true, false},
        {"cerebellum", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cerebellum", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cerebellum", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cerebellum", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cerebellum", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cerebellum", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cerebellum", "mnsync", &mnsync, true, true, false},
        {"cerebellum", "spork", &spork, true, true, false},
        {"cerebellum", "createsporkkeypair", &createsporkkeypair, true, true, false},
        {"cerebellum", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> cerebellum-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:1112/\n";
}
