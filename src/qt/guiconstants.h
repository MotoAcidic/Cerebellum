...
// Copyright (c) 2015-2018 The CEREBELLUM developers
...
/* Cerebellum GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Cerebellum"
#define QAPP_ORG_DOMAIN "freedom.social"
#define QAPP_APP_NAME_DEFAULT "cerebellum-qt"
#define QAPP_APP_NAME_TESTNET "cerebellum-qt-testnet"
