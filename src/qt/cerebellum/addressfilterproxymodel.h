...
#ifndef CEREBELLUM_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define CEREBELLUM_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //CEREBELLUM_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
