...
unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader* pblock)
{
    ...
    /* current difficulty formula, cerebellum - DarkGravity v3, written by Evan Duffield - evan@dashpay.io */
    ...
    if(!consensus.IsTimeProtocolV2(pindexLast->nHeight+1)){
    // return legacy diff calc if timeproto isnt active yet
